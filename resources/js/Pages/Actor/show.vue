        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                ...
                <ul class="flex items-center mt-4">
                        ...
                        <li v-if="social.facebook_id">
                            <a :href="'https://www.facebook.com/'+ social.facebook_id " target="blank" title="Facebook">
                        ...
                        <li v-if="social.instagram_id" class="ml-6">
                            <a :href="'https://www.instagram.com/'+ social.instagram_id " target="blank" title="Instagram">
                        ...
                        <li v-if="social.twitter_id" class="ml-6">
                            <a :href="'https://twitter.com/'+ social.twitter_id" target="blank" title="Twitter">
            ...
            <div class="md:ml-24">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                        ...
                        <div v-for="movie in movies" :key="movie.id" class="mt-4">
                            <inertia-link :href="route('movies.show',movie.id)"><img :src="'https://image.tmdb.org/t/p/w500/'+movie.poster_path " alt="poster" class="hover:opacity-75 transition ease-in-out duration-150"></inertia-link>
                            <inertia-link :href="route('movies.show',movie.id)" class="text-sm leading-normal block text-gray-400 hover:text-white mt-1">{{ movie.title }}</inertia-link>
                        </div>
        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <ul class="list-disc leading-loose pl-5 mt-8">
                    ...
                    <li v-for="movie in movies" :key="movie.id">
                        ...
                        <strong><inertia-link :href="route('movies.show',movie.id)" class="hover:underline">{{ movie.title }}</inertia-link></strong>
                         as {{ movie.character}}
                     </li>
