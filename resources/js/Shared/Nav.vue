        ...
        <div class="container mx-auto px-28 ">
            <div class="container mx-auto  flex flex-col md:flex-row items-center justify-between py-6">
                <ul class="flex flex-col md:flex-row items-center">
                    <li>
                        <inertia-link :href=" route('movies.index') ">
                    ...
                    <li class="md:ml-16 mt-3 md:mt-0">
                        <inertia-link :href=" route('movies.index')" class=" text-yellow-500 hover:text-yellow-400">Movies</inertia-link>
                    </li>
                    <li class="md:ml-6 mt-3 md:mt-0">
                        <inertia-link :href="route('tv.index')" class="text-yellow-500 hover:text-yellow-400">TV Shows</inertia-link>
                    </li>
                    <li class="md:ml-6 mt-3 md:mt-0">
                        <inertia-link :href=" route('actors.index') " class="text-yellow-500 hover:text-yellow-400">Actors</inertia-link>
                    </li>
                </ul>
                <div class="flex flex-col md:flex-row items-center">
                    ...
                    <div class="md:ml-4 mt-3 md:mt-0">
                        ...
                        <div v-else>
                            <inertia-link class="mr-5 text-yellow-500 hover:text-yellow-400" :href="route('login')">Login</inertia-link>
                            <inertia-link class="text-yellow-500 hover:text-yellow-400" :href="route('register')">Register</inertia-link>
                        </div>
                    </div>
                </div>
            </div>
